...
<div class="form-group {{ $errors->has('dni') ? 'has-error' : '' }}">
    ...
    <div class="col-md-12">
        <input class="form-control" name="dni" type="text" id="dni" value="{{ old('dni', optional($persona)->dni) }}" minlength="1" placeholder="Ingrese DNI aqui..." required>
...
<div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
    ...
    <div class="col-md-12">
        <input class="form-control" name="email" type="email" id="email" value="{{ old('email', optional($persona)->email) }}" placeholder="Ingrese email aqui..." required>

...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('pacientes.paciente.update', $paciente->id) }}" id="edit_paciente_form" name="edit_paciente_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}

...
<div class="form-group {{ $errors->has('persona_id') ? 'has-error' : '' }}">
    <label for="persona_id" class="col-md-6 control-label">DNI : {{ $paciente->persona->dni}} </label>
    <div class="col-md-12">
         <input class="form-control" id="persona_id" minlength="1" name="persona_id" value="{{ $paciente->persona_id}}" hidden="">

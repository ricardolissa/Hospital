                ...
                <div class="panel-heading clearfix">
                    ...
                    <div class="col-md-12">
                        <div class="btn-group btn-group-xs pull-right" role="group">
                            ...
                            <a class="btn btn-success" href="{{ route('consultas.consulta.create') }}" title="Crear Consultas">
                    ...
                    <br>
                        <div class="panel-body">
                            ...
                            @endif
                            <form accept-charset="UTF-8" action="{{ route('consultas.consulta.update', $consultas->id) }}" class="form-horizontal" id="edit_consultas_form" method="POST" name="edit_consultas_form">
                                {{ csrf_field() }}
